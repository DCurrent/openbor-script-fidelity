...
#define DC_FIDELITY_TYPE_VOICE_SPELL_FAILED			59	// Magic or special attack fails, can't be used. - "I don't have the energy for that.", "My magic has failed me!", ...
#define DC_FIDELITY_TYPE_VOICE_STOP					60	// Stop request. - "Stop right there.", "Hold up a second!", ...
#define DC_FIDELITY_TYPE_VOICE_TALK_TO_ME			61	// Request to talk. - "We need to chat.", "Please have a word with me.", ...
#define DC_FIDELITY_TYPE_VOICE_TASK_COMPLETE		62	// Task finished. - "All done.", "Finished. What's next?", ...
#define DC_FIDELITY_TYPE_VOICE_TAUNT				63	// Taunt opponent. - "Bring it on chump!", "You don't have a prayer.", ...
#define DC_FIDELITY_TYPE_VOICE_THANKS				64	// Express gratitude. - "I apprciate that.", "Thank you so much.", ...
#define DC_FIDELITY_TYPE_VOICE_THREATEN				65	// Warning. - "You're messing with the wrong guy.", "Keep it up and I'll knock you into last week, so you can wait until now for me to kick your ass again!"
#define DC_FIDELITY_TYPE_VOICE_YES					66	// Agree. - "Sure.", "Yes.", ...
